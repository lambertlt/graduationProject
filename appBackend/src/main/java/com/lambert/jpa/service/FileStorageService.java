...
//            Files.createDirectory(path);
    ...
    public Message save(MultipartFile multipartFile, User user) {
        Message message = null;
        String paths = "FileStorage/" + user.getUsername() + "/" + multipartFile.getOriginalFilename();
        ...
        init(user.getUsername()); // 创建对应用户的个人文件夹
        try {
